...
public class YandexManagedConnection implements ManagedConnection {

    private final YandexManagedConnectionFactory factory;
    ...
    private final List<YandexConnection> connections;

    public YandexManagedConnection(YandexManagedConnectionFactory factory, String username, String password,
    ...
    public Object getConnection(Subject subject, ConnectionRequestInfo cri) throws ResourceException {
        YandexConnection connection = new YandexConnection(this, mailSession, factory.getSenderEmail(), username);
    ...
    public void destroy() throws ResourceException {
        for (YandexConnection connection : connections) {
    ...
    public void associateConnection(Object connection) throws ResourceException {
        if (connection instanceof YandexConnection smtpConn) {
    ...
    public YandexManagedConnectionFactory getFactory() {
        return factory;
    }
